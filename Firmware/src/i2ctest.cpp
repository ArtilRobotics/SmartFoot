...
void setup()
{
    M5.begin(true, true, true,false); // Init M5AtomS3(Initialization of internal I2C is also
                     // included).  M5AtomS3(初始化内部I2C也包含在内)
    Wire.begin(2,1);                         // Detect external I2C, if this sentence is not added,
