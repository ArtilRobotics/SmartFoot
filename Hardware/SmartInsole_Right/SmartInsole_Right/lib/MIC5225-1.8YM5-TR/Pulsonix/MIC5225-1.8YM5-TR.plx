...
(library Library_1
	...
	(symbolDef "MIC5225-1.8YM5-TR" (originalName "MIC5225-1.8YM5-TR")
	...
	(compDef "MIC5225-1.8YM5-TR" (originalName "MIC5225-1.8YM5-TR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MIC5225-1.8YM5-TR"))
		...
		(attr "<Hyperlink>" "http://www.microchip.com/mymicrochip/filehandler.aspx?ddocname=en579718")
		(attr "<Component Height>" "1.3")
		(attr "<STEP Filename>" "MIC5225-1.8YM5-TR.stp")
